const desc =
  "Futbol Club Barcelona, commonly referred to as Barcelona and colloquially known as Barça, is a professional football club based in Barcelona, Catalonia, Spain. The club was founded in 1899 by a group of Swiss, English, and Spanish footballers led by Joan Gamper. They play in La Liga, the top tier of Spanish football and are one of the most successful clubs in the world, having won numerous domestic and international titles, including La Liga, the Copa del Rey, and the UEFA Champions League. They have a strong rivalry with Real Madrid, with matches between the two teams referred to as  The team's home ground is the Camp Nou, which has a capacity of 99,354 seats.";
